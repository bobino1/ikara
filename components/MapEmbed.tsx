...
/** Google mapa s pinom na adrese autoškoly — zobrazená vždy. */
export function MapEmbed({ title }: { title: string }) {
  return (
    <iframe
      title={title}
      src={EMBED_SRC}
      style={{ width: "100%", height: "clamp(260px,34vw,420px)", borderRadius: 22, display: "block", border: 0, overflow: "hidden" }}
      allowFullScreen
      loading="lazy"
